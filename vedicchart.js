module.exports = (newjson)=>{
    var house = ["", "", "", "", "", "", "", "", "", "", "", ""], rasi = ["", "", "", "", "", "", "", "", "", "", "", ""],rasi_no=[1,2,3,4,4,5,6,7,8,9,10,11,12], new_rasi_no=[]
    ...
    for (var key in newjson) {
        ...
        if (!isNaN(key)) {
            ...
            if ((key != 8 && key != 9) && newjson[key].retro == true) {
                ...
                rasi[newjson[key].rasi_no - 1] = rasi[newjson[key].rasi_no - 1].toString() + `${newjson[key].name}(R)` + " "
            } else {
                // console.log("Whyyy",newjson[key].rasi_no)
    
                house[newjson[key].house - 1] = house[newjson[key].house - 1].toString() + newjson[key].name + " "
                rasi[newjson[key].rasi_no - 1] = rasi[newjson[key].rasi_no - 1].toString() + newjson[key].name + " "
            }
        }
...
<body >
    <div style="position: relative;width: auto;width:500px;height:500px;margin: 12px">
       <svg height="500" width="500" style="position: absolute">
        ...
        <div style="position: absolute;height:110px;width:150px;left:175px;top: 150px;font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;display: flex;justify-content: center;align-items: center;color:rgb(83, 83, 83) ">${new_rasi_no[0]} </div>

        <div style="position: absolute;height:110px;width:150px;left:50px;top: 40px;font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;display: flex;justify-content: center;align-items: center;color:rgb(83, 83, 83) ">${new_rasi_no[1]} </div>

    <div style="position: absolute;height:110px;width:150px;left:15px;top: 70px;font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;display: flex;justify-content: center;align-items: center;color:rgb(83, 83, 83) ">${new_rasi_no[2]} </div>

    <div style="position: absolute;height:110px;width:150px;left:125px;top: 200px;font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;display: flex;justify-content: center;align-items: center;color:rgb(83, 83, 83) ">${new_rasi_no[3]} </div>

    <div style="position: absolute;height:110px;width:150px;left:15px;bottom: 70px;font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;display: flex;justify-content: center;align-items: center;color:rgb(83, 83, 83) ">${new_rasi_no[4]} </div>

    <div style="position: absolute;height:110px;width:150px;left:50px;bottom: 40px;font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;display: flex;justify-content: center;align-items: center;color:rgb(83, 83, 83) ">${new_rasi_no[5]} </div>

    <div style="position: absolute;height:110px;width:150px;left:175px;bottom: 150px;font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;display: flex;justify-content: center;align-items: center;color:rgb(83, 83, 83) ">${new_rasi_no[6]} </div>

    <div style="position: absolute;height:110px;width:150px;right:50px;bottom: 40px;font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;display: flex;justify-content: center;align-items: center;color:rgb(83, 83, 83) ">${new_rasi_no[7]} </div>
   
    <div style="position: absolute;height:110px;width:150px;right:15px;bottom: 70px;font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;display: flex;justify-content: center;align-items: center;color:rgb(83, 83, 83) ">${new_rasi_no[8]} </div>

    <div style="position: absolute;height:110px;width:150px;right:125px;top: 200px;font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;display: flex;justify-content: center;align-items: center;color:rgb(83, 83, 83) ">${new_rasi_no[9]} </div>

    <div style="position: absolute;height:110px;width:150px;right:15px;top: 70px;font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;display: flex;justify-content: center;align-items: center;color:rgb(83, 83, 83) ">${new_rasi_no[10]} </div>

    <div style="position: absolute;height:110px;width:150px;right:50px;top: 40px;font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;display: flex;justify-content: center;align-items: center;color:rgb(83, 83, 83) ">${new_rasi_no[11]} </div>
